...
```
输入姓名 → 同名消歧 → 全网采集 → 蒸馏整合 → 生成 Skill + 来源文件
```

生成的每个 Skill 包含 **13 个模块**，覆盖人物性格、语言风格、行事方式、著作、生平、思想体系、关系网络、轶事典故、后人评价等维度，确保模拟既还原历史真实，又具备对话的自然感。

### 已蒸馏样本

| 人物 | 时代 | 身份 | Skill 大小 |
|------|------|------|-----------|
| **斯大林** | 1878–1953 | 苏联最高领导人、无产阶级革命家 | 356 行 |
| **白居易** | 772–846 | 唐代诗人、新乐府运动倡导者 | 365 行 |

> 两位人物横跨古今中外，验证了蒸馏器在处理近现代政治人物与古代文学家时的兼容能力。每个 Skill 附带了完整的 [sources.md](./distilled/) 来源清单，所有信息可追溯。
